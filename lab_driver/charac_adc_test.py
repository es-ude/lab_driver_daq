...
class TestADC(unittest.TestCase):
    ...
    def test_settings_stimuli_8bit_4step(self):
        ...
        set0.num_steps = 8
        stimuli = set0.get_cycle_stimuli_input()
        check = np.array([idx for idx in range(set0.adc_rang[0], set0.adc_rang[1] + 1, set0.num_steps)], dtype=float)
    ...
    def test_settings_result_array(self):
        ...
        check_shape = (set0.num_rpt, int((set0.adc_rang[1] - set0.adc_rang[0] + 1) / set0.num_steps))
