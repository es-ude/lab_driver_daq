...
from elasticai.hw_measurements.charac import CharacterizationNoise, MetricNoise, TransientNoiseSpectrum
from elasticai.hw_measurements.plots import plot_spectrum_noise, plot_transient_noise, plot_spectrum_harmonic
from elasticai.hw_measurements.process.data import do_fft, TransformSpectrum
...
def extract_noise_properties(func_data_loading, overview_data: list, exclude_channels: list,
    ...
    for file_take in overview_data:
        print(file_take)
        # --- Data Loading
        data: TransientData = func_data_loading(file_take)
